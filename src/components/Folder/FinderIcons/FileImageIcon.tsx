export const FileImageIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_2213_9503)">
      <mask
        id="mask0_2213_9503"
      ...
      <g mask="url(#mask0_2213_9503)">
        ...
        <path
          ...
          fill="black"
        />
        <path d="M26 2H25V6H29V5H28V4H27V3H26V2Z" fill="white" />
      </g>
      <path d="M9 10H8V11H9V10Z" fill="black" />
      <path d="M10 10H9V11H10V10Z" fill="black" />
      <path d="M11 10H10V11H11V10Z" fill="black" />
      ...
      <path d="M9 13H8V14H9V13Z" fill="black" />
      ...
      <path d="M9 17H8V18H9V17Z" fill="black" />
      <path d="M10 17H9V18H10V17Z" fill="black" />
      <path d="M11 17H10V18H11V17Z" fill="black" />
      <path d="M12 17H11V18H12V17Z" fill="black" />
      <path d="M13 17H12V18H13V17Z" fill="black" />
      <path d="M15 17H14V18H15V17Z" fill="black" />
      <path d="M16 17H15V18H16V17Z" fill="black" />
      ...
      <path d="M7 18H6V19H7V18Z" fill="black" />
      <path d="M9 18H8V19H9V18Z" fill="black" />
      <path d="M10 18H9V19H10V18Z" fill="black" />
      <path d="M11 18H10V19H11V18Z" fill="black" />
      ...
      <path d="M5 19H4V20H5V19Z" fill="black" />
      <path d="M6 19H5V20H6V19Z" fill="black" />
      <path d="M7 19H6V20H7V19Z" fill="black" />
      <path d="M8 19H7V20H8V19Z" fill="black" />
      <path d="M10 19H9V20H10V19Z" fill="black" />
      <path d="M11 19H10V20H11V19Z" fill="black" />
      <path d="M12 19H11V20H12V19Z" fill="black" />
      <path d="M14 19H13V20H14V19Z" fill="black" />
      <path d="M15 19H14V20H15V19Z" fill="black" />
      ...
      <path d="M5 20H4V21H5V20Z" fill="black" />
      <path d="M6 20H5V21H6V20Z" fill="black" />
      <path d="M7 20H6V21H7V20Z" fill="black" />
      <path d="M8 20H7V21H8V20Z" fill="black" />
      <path d="M9 20H8V21H9V20Z" fill="black" />
      <path d="M13 20H12V21H13V20Z" fill="black" />
      <path d="M14 20H13V21H14V20Z" fill="black" />
      ...
      <path d="M7 21H6V22H7V21Z" fill="black" />
      <path d="M8 21H7V22H8V21Z" fill="black" />
      <path d="M9 21H8V22H9V21Z" fill="black" />
      <path d="M10 21H9V22H10V21Z" fill="black" />
      ...
      <path d="M16 21H15V22H16V21Z" fill="black" />
      <path d="M17 21H16V22H17V21Z" fill="black" />
      ...
      <path d="M7 22H6V23H7V22Z" fill="black" />
      <path d="M8 22H7V23H8V22Z" fill="black" />
      <path d="M9 22H8V23H9V22Z" fill="black" />
      <path d="M10 22H9V23H10V22Z" fill="black" />
      <path d="M11 22H10V23H11V22Z" fill="black" />
